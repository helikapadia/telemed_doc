...
class HomeUpload extends StatelessWidget {
  ...
  const HomeUpload({Key key,@required this.uploadDocumentsBloc}) : super(key: key);
  @override
          ...
          child: Column(
            children: [
              FlatButton(
                  ...
                  child: Text('Upload Documents', style: TextStyle(fontFamily: 'Poppins', color: FONT_BLUE, fontSize: 14),),
              ),
              Text('from Gallery', style: TextStyle(fontFamily: 'Poppins', color: FONT_BLUE, fontSize: 14),),
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Image.asset('images/Upload- Scan.png', height: 160, width: 120,)
                ],
              )
            ],
          ),
