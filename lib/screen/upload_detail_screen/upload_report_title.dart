...
class UploadReportTitle extends StatelessWidget {
  final UploadDocumentsBloc uploadDocumentsBloc;

  const UploadReportTitle({Key key,@required this.uploadDocumentsBloc}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<String>(
      stream: uploadDocumentsBloc.reportName,
